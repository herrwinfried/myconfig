...
if checkwsl; then
    ...
    SUDO $Package $PackageInstall noto-sans-fonts gsettings-desktop-schemas libwayland-client0 libwayland-cursor0 libwayland-server0 xwayland humanity-icon-theme materia-gtk-theme gnome-tweaks qt5ct \
