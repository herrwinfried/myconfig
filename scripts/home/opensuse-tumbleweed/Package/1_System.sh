...
if checkwsl; then
    ...
    SUDO $Package $PackageInstall noto-sans-fonts gsettings-desktop-schemas xorg-x11 xorg-x11-server xwayland humanity-icon-theme materia-gtk-theme gnome-tweaks qt5ct \
