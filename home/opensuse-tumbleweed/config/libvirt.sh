...
echo $green"Adding $Username to kvm, libvirt, input groups..."
$SUDO usermod -aG kvm,libvirt,input $Username | echo $red"Could not add to groups please add manually...$cyan(sudo usermod -aG kvm,libvirt,input $Username)$white"
