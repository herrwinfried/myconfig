...
EOF
sudo $Package addrepo --repo AnyDesk-OpenSUSE.repo

sudo rm -r AnyDesk-OpenSUSE.repo
}
...
sudo $Package addrepo --refresh --repo asus-linux-fedora.repo

sudo rm -r asus-linux-fedora.repo
}
