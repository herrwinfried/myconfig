...
if (IsAdministrator) {
    ...
    Remove-Item "$env:USERPROFILE\Documents\Euro Truck Simulator 2\music"
    Remove-Item "$env:USERPROFILE\Documents\American Truck Simulator\music"

    Remove-Item "$env:USERPROFILE\Documents\Rockstar Games\GTA V\User Music"
    Remove-Item "$env:USERPROFILE\Documents\Rockstar Games\GTA IV\User Music"
