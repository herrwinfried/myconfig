...
function repo_asuscommunity_zypp() {
    ...
    SUDO zypper --gpg-auto-import-keys ar -p 50 -n "Asus Linux (OpenSUSE Tumbleweed)" -r "https://copr.fedorainfracloud.org/coprs/lukenukem/asus-linux/repo/opensuse-tumbleweed/lukenukem-asus-linux-opensuse-tumbleweed.repo" asus-linux
}
