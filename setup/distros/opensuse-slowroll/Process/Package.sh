...
if isWsl; then
    ...
    Packages+=("wl-clipboard" "memtest86+" "AdobeICCProfiles" "onboard")
...
Packages+=("rust" "dotnet-sdk-10.0" "aspnetcore-runtime-10.0" "dotnet-runtime-10.0" "krb5" "libicu" "patterns-devel-mono-devel_mono")
