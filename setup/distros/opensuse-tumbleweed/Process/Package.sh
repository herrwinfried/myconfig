...
PackagesFlatpak+=("org.kde.WaylandDecoration.QAdwaitaDecorations//6.7" "org.kde.WaylandDecoration.QGnomePlatform-decoration//5.15-25.08" "org.kde.WaylandDecoration.QGnomePlatform-decoration//6.5")
...
if isWsl; then
    ...
    Packages+=("wireshark $(echo libguestfs{,-appliance})" "$(echo virt{-install,-manager})" "qemu" "qemu-audio-pipewire" "virtualbox" "virtualbox-host-source")
