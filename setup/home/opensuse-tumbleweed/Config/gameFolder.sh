...
CreateDesktopEntry $USERHOME/Games/Bottles com.usebottles.bottles-program
mkdir -p $USERHOME/Games/Heroic
CreateDesktopEntry $USERHOME/Games/Heroic com.heroicgameslauncher.hgl
mkdir -p $USERHOME/Games/SteamData
CreateDesktopEntry $USERHOME/Games/SteamData steam
mkdir -p $USERHOME/Games/Lutris
CreateDesktopEntry $USERHOME/Games/Lutris net.lutris.Lutris
