...
# HELP ME!!!
#    docker build -t herrwinfried/dev_env:full-server-ltsc22 . -f ./full-server-ltsc22.dockerfile 
#    New-Item -Path "C:\" -Name "Host" -ItemType "directory"
#    docker run -it -v C:\Host:C:\Host:rw --name server -p 3256:22 herrwinfried/dev_env:full-server-ltsc22
