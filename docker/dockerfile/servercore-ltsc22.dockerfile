...
# HELP ME!!!
#    docker build -t herrwinfried/dev_env:servercore-ltsc22 . -f ./servercore-ltsc22.dockerfile 
#    New-Item -Path "C:\" -Name "Host" -ItemType "directory"
#    docker run -it -v C:\Host:C:\Host:rw --name servercore -p 3256:22 herrwinfried/dev_env:servercore-ltsc22
